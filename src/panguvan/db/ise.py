...
class Instrument(SQLModel, table=True):
    ...
    activity_id: int = Field(foreign_key="ise_activity.id")
...
class DailyHistPrice(SQLModel, table=True):
    ...
    __table_args__ = (
        UniqueConstraint('date', 'ins_id', name="ise_daily_hist_price_unique_date_ins_id"),
    )
...
class DailyAdjHistPrice(SQLModel, table=True):
    ...
    __table_args__ = (
        UniqueConstraint('date', 'ins_id', name="ise_daily_adj_hist_price_unique_date_ins_id"),
    )
